...
namespace DigitalRuby.WeatherMaker
{
    public class WeatherMakerConfigurationScript : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            InvokeRepeating("DisplayFPS", 0.0f, 0.5f);

            if (UnityEngine.EventSystems.EventSystem.current == null)
            {
                Debug.LogError("There must be an EventSystem in your scene to use the configuration panel");
            }
        }
        ...
        public void CloudToggleChanged()
        {
            ...
            else
            {
                ...
                WeatherScript.SkySphereScript.ShowCloudsAnimated(TransitionDurationSlider.value, 1.0f, 0.8f, 0.25f, Color.white);
            }
        }
